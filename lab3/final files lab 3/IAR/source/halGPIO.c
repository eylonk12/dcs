...
// Strings to screen.
char starting_string1[15] = {'R', 'e', 'c', 'o', 'r', 'd', 'i', 'n', 'g', ' ', 'S', 't', 'a', 'r', 't'};
char starting_string2[11] = {'P', 'r', 'e', 's', 's', ' ', 'a', ' ', 'k', 'e', 'y'};
char output_string[16] = {'R', 'e', 'c', 'o', 'r', 'd', ' ', 'L', 'e', 'n', 'g', 't', 'h', ':', ' ', ' '};
char audio_menu_1[16] = {'N', 'o', 'w', ' ', 'c', 'h', 'o', 'o', 's', 'e', ' ', 's', 'o', 'n', 'g', ':'};
char audio_menu_2[16] = {'P', 'r', 'e', 's', 's', ' ', 'P', 'B', '2', ' ', 's', 'c', 'r', 'o', 'l', 'l'};
char audio_menu_3[14] = {'L', '1', '-', 'H', 'a', 'd', 'o', 'd', ' ', 'M', 'o', 's', 'h', 'e'};
char audio_menu_4[16] = {'L', '2', '-', 'H', 'a', 'o', 't', 'o', ' ', 'S', 'h', 'e', 'l', 'a', 'n', 'o'};
char audio_menu_5[16] = {'L', '3', '-', 'Y', 'a', 'd', 'a', 'i', 'm', ' ', 'L', 'e', 'm', 'a', 'l', 'a'};
char audio_menu_6[16] = {'L', '4', '-', 'R', 'e', 'c', 'o', 'r', 'd', 'e', 'r', ' ', 's', 'o', 'n', 'g'};
char strMirror[157] = "";
// variables
